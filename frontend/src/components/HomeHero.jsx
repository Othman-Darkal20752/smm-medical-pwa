...
const FALLBACK_HERO_SLIDES = [
  {
    ...
    desktopImage: "/hero/hero-1-desktop.webp?v=8",
    mobileImage: "/hero/hero-1-mobile.webp?v=8",
  },
  {
    source: "fallback",
    ...
    desktopImage: "/hero/hero-2-desktop.webp?v=8",
    mobileImage: "/hero/hero-2-mobile.webp?v=8",
  },
  {
    source: "fallback",
    ...
    desktopImage: "/hero/hero-3-desktop.webp?v=8",
    mobileImage: "/hero/hero-3-mobile.webp?v=8",
  },
];
...
function HomeHero() {
  ...
  useEffect(() => {
    ...
    async function loadHeroSlides() {
      try {
        ...
        setSlides(apiSlides.length > 0 ? apiSlides : FALLBACK_HERO_SLIDES);
        setActiveSlide(0);
      } catch (error) {
  ...
  const isApiSlide = slide.source === "api";
  const shouldShowCopy = !isApiSlide;

  return (
    <section
      className={`hero-carousel hero-image-carousel ${isApiSlide ? "hero-dashboard-image" : "hero-fallback-image"}`}
      id="home-section"
